      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-10">
        <div className="max-w-xl">
          <h1 className="text-3xl md:text-5xl font-light mb-4 text-white drop-shadow-lg">
            Discover beautiful food at your doorstep.
          </h1>
          <p className="text-lg mb-8 text-white/90 drop-shadow-md">
            Quality food ready to be delivered to your doorstep.
          </p>
          <div>
            <button
              onClick={() => navigate("/")}
              className="bg-white hover:bg-gray-100 px-10 py-4 text-gray-900 rounded-lg border-0 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
              Shop Now
            </button>
          </div>
